...
public class PdfPaging extends PdfPageEventHelper {
	private String jde;
	private int totalJde;
	/** The PdfTemplate that contains the total number of pages. */
	protected PdfTemplate total;
	
	public int getTotalJde() {
		return totalJde;
	}
	public void setTotalJde(int totalJde) {
		this.totalJde = totalJde;
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			writer.setPageEvent(new PdfPaging());
