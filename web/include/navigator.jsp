...
<s:if test="#accSession!=null"> 
	...
	<s:elseif test="#accSession.accType==0">
				...
				<td <s:if test='#selectPage=="search"'>class="selectednavi" <s:set name="addPage" value="1"></s:set></s:if><s:elseif test="#addPage==0"><s:set name="currentPage" value="#currentPage+1"></s:set></s:elseif>>
				<a href =".action"  onclick="return navigationLoading();"><b>Post</b></a></td>
